namespace Utilities_ {
    export function generateUID(): string {
        return (
            s4_() + s4_() + '_' + s4_() + '_' + s4_() + '_' + s4_() + '_' + s4_() + s4_() + s4_()
        );
    }
    ...
    export function getRangeForTable(
        ...
        while (true) {
            try {
                ...
                if (retries > maxRetries) {
                    ...
                    let sleepTimeMs =
                        Math.random() * (+sleepTimeMaxMs - +sleepTimeMinMs) + +sleepTimeMinMs;
    ...
    export function formatDateRelativeTo(date: Date, realtiveTo: Date, timeZone: string): string {
        ...
        if (
            realtiveTo.getFullYear() == date.getFullYear() &&
            realtiveTo.getMonth() == date.getMonth() &&
            realtiveTo.getDate() == date.getDate()
        ) {
