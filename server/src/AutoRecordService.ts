...
namespace AutoRecordService {
    export function createAutoRecordBinding(
    ...
    export function deleteAutoRecordBinding(
        sheet: GoogleAppsScript.Spreadsheet.Sheet,
        bookId: string,
        properties: GoogleAppsScript.Properties.Properties
    ): AutorecordConfig {
    ...
    export function loadAutoRecordConfig(
        sheet: GoogleAppsScript.Spreadsheet.Sheet,
        bookId: string,
        properties: GoogleAppsScript.Properties.Properties
    ): AutorecordConfig {
    ...
    export function processAutoRecord(
    ...
    function recordLines_(
        sheet: GoogleAppsScript.Spreadsheet.Sheet,
        binding: AutorecordBinding,
        autoRecordSheetsBindingDAO: AutoRecordSheetBindingDAO,
        timeZone: string
    ) {
